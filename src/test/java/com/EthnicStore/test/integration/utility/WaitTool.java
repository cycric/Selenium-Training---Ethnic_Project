...
//		return null; 
	...
	public static WebElement waitForElementPresentBy(WebDriver driver, final By by, int timeOutInSeconds) {
		WebElement element; 
		try{
			driver.manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS); //nullify implicitlyWait() 
	...
	public static boolean waitForElementPresentBy(final By by, int timeOutInSeconds) {
		WebElement element; 
		try{
			Browser.driver().manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS); //nullify implicitlyWait() 
